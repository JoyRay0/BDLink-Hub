...
public class c_api_config {
    ...
    public String getGet_links_user_info() {
        return get_links_user_info;
    }

    public String getGoogle_ad() {
        return google_ad;
    }

    public String getItem_links() {
        return item_links;
    }

    public String getP_item_links() {
        return P_item_links;
    }

    public String getUser_reg_login_delete_account() {
